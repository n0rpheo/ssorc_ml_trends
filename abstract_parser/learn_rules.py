...
if __name__ == '__main__':
    ...
    learned_rules_filename = "learned_rules_it4.json"
    ...
    # Loading Rules
    rules = load_rules(os.path.join(path_to_patterns, seed_rules_filename))

    """
    Example for rule representation within the file:
    
    {"category": "Objective", "trigger_word": "studies", "dependency": "dep"}
    {"category": "Objective", "trigger_word": "introduce", "dependency": "dobj"}
    {"category": "Objective", "trigger_word": "proposes", "dependency": "dobj"}
    {"category": "Background", "trigger_word": "demands", "dependency": "advcl"}
    {"category": "Background", "trigger_word": "review", "dependency": "dobj"}
    {"category": "Method", "trigger_word": "divides", "dependency": "dobj"}
